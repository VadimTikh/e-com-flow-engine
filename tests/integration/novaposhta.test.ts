...
const TEST_TTN_NOVAPOSHTA = process.env.TEST_TTN_NOVAPOSHTA || '';

describe('NovaPoshta Registers Integration Test', () => {
    if (!API_KEY || !TEST_TTN_NOVAPOSHTA) {
        console.warn('Skipping Registers integration tests: NOVA_POSHTA_API_KEY or TEST_TTN_NOVAPOSHTA not found');
        it.skip('should pass', () => {});
        return;
    }
